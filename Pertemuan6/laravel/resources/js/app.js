        ...
        k(e, (e) =>
            "at-rule" === e.kind && "@slot" === e.name
                ...
                : "at-rule" !== e.kind ||
                  ...
                  ? void 0
                  : (Object.assign(e, T([A(e.name, e.params, e.nodes)])),
                    w.Skip),
        );
    }
    function tt(e, t) {
                ...
                (r("first", ["&:first-child"]),
                    ...
                    t.functional("aria", (e, t) => {
                        ...
                        "arbitrary" === t.value.kind
                            ...
                            : (e.nodes = [
                                  $(`&[aria-${t.value.value}="true"]`, e.nodes),
                              ]);
                    }),
                    t.suggest("aria", () => [
                        "busy",
