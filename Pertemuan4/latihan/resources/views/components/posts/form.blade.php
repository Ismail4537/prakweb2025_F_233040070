...
<form action="{{ route('dashboard.store') }}" method="POST">
    ...
    <div class="grid gap-4 grid-cols-2">
        ...
        <div class="col-span-2">
            ...
            <select name="category_id" id="category_id" class="block w-full px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-basefocus:ring-brand focus: border-brand shadow-xs placeholder: text-body">
